...
cor_value = pd.Series(boston_df['NOX']).corr(pd.Series(boston_df['INDUS']))

import statsmodels.api as sm
X = sm.add_constant(boston_df[['INDUS']])  # Add constant term
model_sm = sm.OLS(boston_df['NOX'], X).fit()
